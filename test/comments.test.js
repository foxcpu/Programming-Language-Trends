...
const Comments = require('../script/comments.js');
const { stripMentionsFromRepoDesc } = require('../script/issue-updater.js');
...
describe('comments', function () {
  ...
  it('should load comments from all pages', async function () {
    const comments = await new Comments({number: 1}).getAll();
